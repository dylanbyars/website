...
const PeriodicTable = () => {
  ...
  return (
    <main title='Periodic Table of the Elements · Dylan Byars'>
      <Head>
        <title>Periodic Table of the Elements · Dylan Byars</title>
      ...
      >
        ...
        {activeElement && <Modal element={activeElement} closeModal={clearActiveElement} />}
      </div>
    </main>
  )
}
